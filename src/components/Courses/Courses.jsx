...
const Services = () => {
  ...
  return (
    <div className="relative">
      ...
      <div className=" mx-auto flex flex-col-reverse grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-3">
        <div className="container flex-col grid md:grid-cols-2 lg:grid-cols-2 md:col-span-2 lg:col-span-3 gap-10 my-4 ">
          {datas.map((data) => (
